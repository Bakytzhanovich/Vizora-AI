...
async def generate_chat_response(
    ...
    if language == "kz":
        ...
        citation_rules = """ДЕРЕККӨЗДЕРГЕ СІЛТЕМЕ ЖАСАУ ЕРЕЖЕЛЕРІ:
- Ақпарат [официальный источник] деп белгіленсе — "Ресми деректер бойынша..." деп жаз
- [по данным агентств] болса — "Агенттіктердің деректері бойынша..." деп жаз
- [по опыту студентов] болса — МІНДЕТТІ ТҮРДЕ "Кейбір студенттердің тәжірибесі бойынша..." деп жаз және бұл ресми ақпарат емес екенін қос
- Студенттердің тәжірибесін ешқашан ресми факт ретінде бермеу"""
    else:
        language_instruction = "Отвечай ТОЛЬКО на русском языке."
        citation_rules = """ПРАВИЛА ЦИТИРОВАНИЯ ИСТОЧНИКОВ:
