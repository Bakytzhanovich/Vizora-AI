...
export default function AfterVisaPage() {
  ...
  if (data && !data.unlocked) {
    return (
      <div className="min-h-screen bg-[#0A0A0F] flex flex-col items-center justify-center px-4 text-center gap-4">
        <div className="text-5xl">🔒</div>
        <h2 className="text-[#F0F0FF] font-bold text-xl">Раздел заблокирован</h2>
        <p className="text-[#8B8BA7] text-sm max-w-xs">
    ...
    <div className="min-h-screen bg-[#0A0A0F]">
      ...
      <div className="sticky top-0 z-20 bg-[#0A0A0F]/95 backdrop-blur border-b border-[#1E1E2E]">
        <div className="max-w-2xl mx-auto px-4 py-4 flex items-center gap-3">
          ...
          <div>
            <h1 className="text-[#F0F0FF] font-bold leading-tight">После визы</h1>
            <p className="text-[#8B8BA7] text-xs">Подготовка к поездке и жизнь в США</p>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-2xl mx-auto px-4 py-6">
        ...
        <motion.div
          ...
          className="bg-gradient-to-r from-[#00D4AA]/10 to-[#00B894]/5 border border-[#00D4AA]/20 rounded-2xl p-5 mb-6"
        >
          <div className="text-3xl mb-2">🎉</div>
          <h2 className="text-[#F0F0FF] font-bold text-lg mb-1">Поздравляем с визой!</h2>
        ...
        {data && (
          <motion.div
            ...
            className="bg-[#13131A] border border-[#1E1E2E] rounded-2xl p-4 mb-6"
          >
            <div className="flex items-center justify-between mb-2">
              <span className="text-[#F0F0FF] text-sm font-semibold">Общий прогресс</span>
              <span className="text-[#00D4AA] text-sm font-bold">{data.overall_pct}%</span>
            </div>
        ...
        {data && (
          ...
          >
            <h2 className="text-[#F0F0FF] font-semibold text-sm mb-3">Все разделы</h2>
